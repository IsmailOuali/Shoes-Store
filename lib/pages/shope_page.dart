...
class _ShopPageState extends State<ShopPage> with TickerProviderStateMixin {
  ...
  final List<Shoe> _shoes = [
    Shoe(
      ...
      description:
          'Classic basketball shoe with premium leather upper and iconic design',
      category: 'Basketball',
      rating: 4.8,
      reviewCount: 2847,
    ),
    Shoe(
      ...
      imagePath: 'lib/images/Air1.jfif',
      description:
          'Comfortable running shoe with large Air unit for maximum cushioning',
      category: 'Running',
      rating: 4.6,
      reviewCount: 1923,
    ),
    ...
    Shoe(
      ...
      imagePath: 'lib/images/Air1.jfif',
      description:
          'Iconic basketball shoe with timeless design and all-day comfort',
      category: 'Sneakers',
      rating: 4.9,
      reviewCount: 4521,
    ),
    Shoe(
      ...
      imagePath: 'lib/images/Air1.jfif',
      description:
          'Advanced running shoe with React foam for responsive cushioning',
      category: 'Running',
      rating: 4.5,
      reviewCount: 1687,
    ),
    Shoe(
      ...
      imagePath: 'lib/images/Air1.jfif',
      description:
          'Premium basketball shoe with mesh panels and visible Air cushioning',
      category: 'Basketball',
      rating: 4.8,
      reviewCount: 2134,
    ),
    Shoe(
      ...
      price: '\$100',
      imagePath: 'lib/images/Air1.jfif',
      description: 'Vintage-inspired sneaker with classic basketball heritage',
      category: 'Lifestyle',
      rating: 4.4,
      reviewCount: 1456,
    ),
    Shoe(
      ...
      imagePath: 'lib/images/Air1.jfif',
      description:
          'Futuristic design with full-length Air cushioning and metallic accents',
      category: 'Running',
      rating: 4.6,
      reviewCount: 2890,
    ),
